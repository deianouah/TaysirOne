...
const Header = () => {
  ...
  const isRtl = language === "ar" || language === "ar-SA" || language === "sa";
            ...
            <nav className={`hidden lg:flex items-center gap-1 ${isRtl ? "mr-8 flex-row-reverse" : "ml-8 flex-row"}`}>
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                      className={`w-3.5 h-3.5 ${isRtl ? "mr-1" : "ml-1"} transition-transform duration-300 ${
              ...
              {!isAuthenticated && (
                <div className={`flex items-center gap-2 ${isRtl ? "mr-2" : "ml-2"}`}>
                  ...
                  >
                    ...
                    <ArrowRight className={`w-4 h-4 ${isRtl ? "mr-2" : "ml-2"} group-hover:translate-x-1 transition-transform duration-300`} />
                  </Link>
                </div>
              )}
